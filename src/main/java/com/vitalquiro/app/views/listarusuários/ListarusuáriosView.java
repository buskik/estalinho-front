package com.vitalquiro.app.views.listarusuários;
...
@RolesAllowed("ADMIN")
@Uses(Icon.class)
public class ListarusuáriosView extends Div {
    ...
    public ListarusuáriosView(SamplePersonService SamplePersonService) {
        this.samplePersonService = SamplePersonService;
        setSizeFull();
        addClassNames("listarusuários-view");
